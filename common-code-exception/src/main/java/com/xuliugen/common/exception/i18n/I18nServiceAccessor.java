...
public class I18nServiceAccessor implements Serializable {
     ...
     * default locale.
     * @param i18nService the i18nService to wrap
     * @see com.flightroutes.common.commoncode.util.i18n.dayatang.i18n.LocaleContextHolder#getLocale()
     */
     ...
     * @param code code of the message
     * @return the message
     * @throws com.dayatang.i18n.NoSuchMessageException if not found
     */
